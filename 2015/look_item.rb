...
#look item save Down
    ...
    if lokupitem >= lokrigitem = 0 && lokupitem >= lokleftitem &&  lokupitem >= lokdownitem
      go = 0
    elsif  lokrigitem >= lokupitem = 0 &&  lokrigitem >= lokleftitem &&   lokrigitem >= lokdownitem
      go = 3
    elsif lokleftitem >= lokupitem = 0 &&  lokleftitem >=  lokrigitem &&    lokleftitem >= lokdownitem
      go = 1
    elsiflokdownitem >= lokupitem = 0 &&  lokdownitem >=  lokrigitem &&    lokdownitem >= lokleftitem
    go = 3
    end
    mode = 0
    lokupitem = 0
