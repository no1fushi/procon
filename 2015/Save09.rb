...
if tarn == 4
  if shitemU >= shitemD && shitemU >= shitemR && shitemU >= shitemL
    go = 0
  end
  if shitemD >= shitemU && shitemD >= shitemL &&  shitemD >= shitemR
    go = 2
  end
  if shitemR >= shitemD && shitemR >= shitemL &&  shitemR >= shitemU
  go = 3
  end
  if shitemL >= shitemD && shitemL >= shitemR &&  shitemL >= shitemU
    go = 1
  end
end
#block
